...
const policiesLogsWithName: PolicyLogWithName[] = [
  {
    end: '2024-01-19T07:58:00.033000+00:00',
    error: null,
    job_name: 'JOB_NAME1',
...
const policyLog: PolicyLogWithName = {
...
const policyErrorLog: PolicyLogWithName = {
  ...policiesLogs[0],
  job_name: 'JOB_NAME',
  error: 'Query error',
  statements: {
...
const policyLogRunning: PolicyLogWithName = {
  ...policyLog,
  end: null,
};
