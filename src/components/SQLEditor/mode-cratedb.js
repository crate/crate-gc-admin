...
// try / catch to prevent tests failing when ace is unavailable
export function registerCrateDbMode() {
  if (registered || typeof ace === 'undefined') {
    return;
  }
...
export function getCrateDbMode() {
  registerCrateDbMode();
  if (typeof ace === 'undefined') {
    return undefined;
  }

  return ace.require('ace/mode/cratedb').Mode;
}
